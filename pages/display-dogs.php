               ...
               <a id="ActDelBtn" href="javascript:void(0);" class="text-danger"  data-id="<?= $key?>" data-mdb-toggle="modal" data-mdb-target="#delete<?= $key?>" >
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form action="./controller/pets.controller.php" method="POST" class="" enctype='multipart/form-data'>
                                            ...
                                            <div class="form-outline mb-3">
                                                <input type="text" name="q10" value="<?= $cats['q10'] ?>" class="form-control form-control rounded-0" required />
                                            ...
                                            <input type="submit" name="update_dog" class="btn btn-success form-control my-3 rounded-0" data-mdb-ripple-color="dark" value="SUBMIT">
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="dogDeleteModal"><span id="title-2" class="text-uppercase"></span>Delete Cat</h5>
                                    <button
                                    type="button"
                                    class="btn-close"
                                    data-mdb-dismiss="modal"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <form action="./controller/pets.controller.php" method="POST" class="" enctype='multipart/form-data'>
                                        ...
                                        <input  type="hidden" name="cid" value="<?= $key ?>">
                                        <input type="submit" name="delete_dog" class="btn btn-success form-control my-3 rounded-0" data-mdb-ripple-color="dark" value="SUBMIT">
                                    </form>
                                </div>
                            </div>
                        </div>
