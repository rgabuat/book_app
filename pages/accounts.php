    ...
    <table id="accountsTable" class="display">
        ...
        <tbody>
            ...
            ?>
                ...
                <td>
               <span>
               <a id="editBtn" href="?page=accountedit&id=<?= $key['id'] ?>" class="text-warning" data-id="<?= $key['id'] ?>" data-title="Edit" data-action="edit" data-mdb-toggle="tooltip" data-mdb-placement="top" title="Edit">
